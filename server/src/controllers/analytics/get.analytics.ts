...
import MaintenanceLog from '../../models/maintenance.schema';
import response from '../../response/response';
import analyticsQuerySchema from '../../validations/analytics.validator';
import calculateFuelEfficiency from './calculateFuelEfficiency';
import calculateVehicleROI from './calculateVehicleROI';
import calculateUtilizationRate from './calculateUtilizationRate';
import calculateMonthlyFinancial from './calculateMonthlyFinancial';
import calculateFleetKPIs from './calculateFleetKPIs';
import getTopCostliestVehicles from './getTopCostliestVehicles';
import getDeadStock from './getDeadStock';
